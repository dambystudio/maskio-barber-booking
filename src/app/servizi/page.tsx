  ...
  return (
    <main className="relative min-h-screen pt-24 pb-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">I Nostri Servizi</h1>
            ...
            >
              ...
              <div className="px-6 pb-6">
                <motion.div
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  <BookingButton className="w-full bg-gray-900 hover:bg-gray-800 text-white font-semibold py-3 px-6 rounded-lg transition-colors">
