    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-amber-100 flex items-center justify-center p-4">
      ...
      >
        ...
        <motion.button
          ...
          disabled={loading}
          className="w-full bg-white border-2 border-gray-200 text-gray-700 py-3 px-4 rounded-lg font-medium hover:border-gray-300 transition-colors mb-6 flex items-center justify-center gap-3"
        >
